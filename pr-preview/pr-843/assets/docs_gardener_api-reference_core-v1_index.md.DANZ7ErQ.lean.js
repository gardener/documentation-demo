import{c as o,o as d,j as e,a}from"./chunks/framework.Bfq10Vlj.js";const s=JSON.parse('{"title":"Core V1","description":"","frontmatter":{"github_repo":"https://github.com/gardener/gardener","github_subdir":"docs/api-reference","params":{"github_branch":"master"},"path_base_for_github_subdir":{"from":"content/docs/gardener/api-reference/core-v1.md","to":"core-v1.md"},"title":"Core V1","prev":false,"next":false},"headers":[],"relativePath":"docs/gardener/api-reference/core-v1/index.md","filePath":"docs/gardener/api-reference/core-v1.md","lastUpdated":null}'),c={name:"docs/gardener/api-reference/core-v1/index.md"},p=Object.assign(c,{setup(n){const r=`<p>Packages:</p>
<ul>
<li>
...
</em></p>`;return(l,t)=>(d(),o("div",null,[t[0]||(t[0]=e("h1",{id:"core-v1",tabindex:"-1"},[a("Core V1 "),e("a",{class:"header-anchor",href:"#core-v1","aria-label":'Permalink to "Core V1"'},"​")],-1)),e("div",{innerHTML:r})]))}});export{s as __pageData,p as default};
